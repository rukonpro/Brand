    ...
    return (
        <form onSubmit={formik.handleSubmit}>
            <div className="grid grid-cols-2 gap-2">
                <div>
                    <input
                        ...
                        className={`px-3 py-2 rounded-lg  w-full my-1 bg-white/50 border-2 ${formik.touched.firstName && formik.errors.firstName ? "border-red-400" : "border-white"}`}
                ...
                <div>
                    <input
                        ...
                        className={`px-3 py-2 rounded-lg w-full my-1 bg-white/50 border-2 ${formik.touched.lastName && formik.errors.lastName ? "border-red-400" : "border-white"}`}
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                    />
            ...
            <input
                ...
                className={`px-3 py-2 rounded-lg w-full my-1 bg-white/50 border-2 ${formik.touched.rePassword && formik.errors.rePassword ? "border-red-400" : "border-white"}`}
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
            />
