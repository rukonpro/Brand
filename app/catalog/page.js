...
export const metadata = {
    title: 'Catalog - Brand',
    description:
        'Browse the comprehensive catalog of products at Brand. From the latest trends to essential items, discover everything you need in one convenient location. Shop now and enjoy exclusive offers!',
    keywords: 'catalog, product catalog, online shopping, fashion, electronics, Brand',
    openGraph: {
        title: 'Catalog - Brand',
        description:
            'Browse the comprehensive catalog of products at Brand. From the latest trends to essential items, discover everything you need in one convenient location. Shop now and enjoy exclusive offers!',
        url: 'https://brand-rukon.vercel.app/catalog',
        type: 'website',
    },
    twitter: {
        card: 'summary',
