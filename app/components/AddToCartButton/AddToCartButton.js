    ...
    return (
        cartProduct===undefined ?
            <button
                ...
                type="button"
                className="flex items-center gap-1 md:gap-x-2  py-1  border-2 rounded-lg text-blue-600 mt-4 w-full justify-center hover:border-blue-500 ">
            ...
            <div
                ...
                <button
                    type="button"
                    className="  py-1 w-full h-full  justify-center">
