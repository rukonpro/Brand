...
const SupplierCard = () => {
    return (
        <div className="border-2 rounded  p-2 bg-white dark:bg-slate-700 dark:border-slate-700">
            ...
            <ol className="  border-t-2 py-2 dark:border-slate-700">
            ...
            <div>
                ...
                <button
                    className="w-full bg-gray-100 dark:border-2 dark:border-slate-700 dark:bg-slate-800 border-2  hover:border-blue-500  rounded-2xl py-2 text-blue-500 font-bold  mt-2 ">{`Seller's Profile`}</button>
            </div>
        </div>
    );
};
