    ...
    return (
        <div className="lg:border-2 border-blue-200 md:rounded-lg p-3 bg-white dark:bg-slate-700 dark:border-slate-700">
            <Link href={`/details/${product?.id}`}>
                ...
                <h1 className="text-xl font-bold text-black pt-2 dark:text-slate-50">${product.price}</h1>


                <h2 className="text-gray-600 text-sm pt-2 dark:text-slate-300">GoPro HERO6 4K Action Camera -
                    Black</h2>
            </Link>
            <button
                onClick={() => {
