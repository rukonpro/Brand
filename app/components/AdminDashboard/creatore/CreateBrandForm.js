    ...
    return (
        <div className="max-w-xl mx-auto p-4 bg-white shadow-md rounded-md">
            <form onSubmit={formik.handleSubmit}>
                ...
                {/* Name Field */}
                <div className="mb-4">
                    <label htmlFor="name" className="block text-sm font-medium text-gray-700">Band Name</label>
                    <input
                        type="text"
                        id="name"
                        name="name"
                        className={`mt-1 block w-full px-3 py-2 border ${formik.touched.name && formik.errors.name ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
                ...
                <div className="mb-4">
                    ...
                    <input
                        ...
                        id="website"
                        name="website"
                        className={`mt-1 block w-full px-3 py-2 border ${formik.touched.website && formik.errors.website ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
