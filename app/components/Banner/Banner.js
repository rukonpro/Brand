                ...
                <div className='grid grid-cols-12 gap-3'>
                    <div className='md:col-span-3 col-span-12 px-3 md:px-0'>
                       <ul className="">
                           ...
                           <li>
                               <Link href="" className='w-full inline-block px-3 py-2 mt-2 rounded-lg hover:bg-[#E3F0FF]'>Computer
                                   and tech</Link>
                           </li>
                          <li>
                              <Link href="" className='w-full inline-block px-3 py-2 mt-2 rounded-lg hover:bg-[#E3F0FF]'>Tools,
                                  equipments</Link>
                          </li>
                         <li>
                             <Link href="" className='w-full inline-block px-3 py-2 mt-2 rounded-lg hover:bg-[#E3F0FF]'>Sports
                                 and outdoor</Link>
                         </li>
                          <li>
                              <Link href="" className='w-full inline-block px-3 py-2 mt-2 rounded-lg hover:bg-[#E3F0FF]'>Animal
                                  and pets</Link>
                          </li>
                          <li>
                              <Link href="" className='w-full inline-block px-3 py-2 mt-2 rounded-lg hover:bg-[#E3F0FF]'>Machinery
                                  tools</Link>
                          </li>
                       </ul>
                    </div>
